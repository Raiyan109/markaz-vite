...
const Success = () => {
    ...
    return (
        <div className="px-10 mb-[450px] md:mb-96 relative">
            ...
            <div className='bg-white p-3 absolute -bottom-36 md:-bottom-48 right-20 md:right-32 rounded-xl flex flex-col gap-2 md:gap-5 w-80 h-64 md:w-80 md:h-72'>
                <img src={success2} alt="" className='  object-cover rounded-xl' />
            ...
            <div className='absolute -bottom-96 md:-bottom-56 left-10 space-y-5'>
                <h5>Alumni achievements</h5>
                <div>
                    <h3 className='max-w-md'>Our graduates go on to achieve remarkable success in various fields. </h3>
                    <h3 className='text-gray-500 max-w-md'>Read about their journeys and how Markajul Quran helped shape their </h3>
                </div>
            </div>
        </div>
    )
