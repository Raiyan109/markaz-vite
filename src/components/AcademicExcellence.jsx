    ...
    return (
        <div className='px-10 py-32'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8 md:gap-20' >
                ...
                <h6 className='max-w-md md:max-w-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus non, dolorem officiis nulla architecto cum hic possimus libero in minus accusantium quia obcaecati incidunt quisquam autem harum, ullam a itaque.</h6>
            </div>
